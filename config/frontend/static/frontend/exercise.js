class Exercise{
    ...
    ***********************/
    ...
    static getLearningTimeElement(){
        return document.getElementById("exercise-learning-time");
    }

    static getReviewWordsElement(){
        return document.getElementById("exercise-review-words");
    }

    static getRetentionProbElement(){
        return document.getElementById("exercise-retention-prob");
    }
    ...
    ***********************/
    static unhighlightButton(type){
        ...
        if(!className.includes("btn-outline-")){
            ...
            elt.innerHTML = capitalizeFirstLetter(type);
            elt.dataset.selected = false;
        }
        return elt;
    }
    ...
    ***********************/
    ...
    static showCard(){
        ...
        // show statistics
        var retentionElt = Exercise.getRetentionProbElement();
        retentionElt.innerText = "Retention Prob: " + Math.round(info.prob*1000)/10 + "%";
    }
    ...
    static selectAnswer(buttonDOM){
        if(buttonDOM.dataset.selected=="true"){
        ...
        var answer = buttonDOM.dataset.answer;
    ...
    static definitionOnclick(obj){
        var idx = Exercise.getCurrentIdx();
        if(obj.dataset.type=="definition"){
            Exercise.showWaitingInfoInDefinition(idx);
        }else{
            Exercise.showDefinition(idx);
        }
